...
@section('css')
	<link rel="stylesheet" type="text/css" href="{{asset('homepage/styles/contact_styles.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('homepage/styles/contact_responsive.css')}}">
@endsection	
@section('content')
<!-- Contact Info -->
			...
			<div class="col-lg-10 offset-lg-1">
				<div class="contact_info_container d-flex flex-lg-row flex-column justify-content-between align-items-between">
					...
					<div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
						<div class="contact_info_image"><img src="{{asset('homepage/images/contact_1.png')}}" alt=""></div>
					...
					<!-- Contact Item -->
					<div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
						<div class="contact_info_image"><img src="{{asset('homepage/images/contact_2.png')}}" alt=""></div>
						<div class="contact_info_content">
					...
					<!-- Contact Item -->
					<div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
						<div class="contact_info_image"><img src="{{asset('homepage/images/contact_3.png')}}" alt=""></div>
						<div class="contact_info_content">
...
<script src="{{asset('js/homepage/contact_custom.js')}}"></script>
@endsection
@endsection
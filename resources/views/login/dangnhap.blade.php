...
<html>
  <head>
    ...
    <!-- orion icons-->
    <link rel="stylesheet" href="{{asset('assets/customlogin/orionicons.css')}}">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{asset('assets/customlogin/style.default.css')}}" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="{{asset('assets/customlogin/custom.css')}}">
    <!-- Favicon-->
   <link rel="shortcut icon" href="{{asset('assets/customlogin/img/favicon.png')}}">
  ...
  <body>
      ...
      <div class="container">
        <div class="row align-items-center py-5">
          <div class="col-5 col-lg-7 mx-auto mb-5 mb-lg-0">
            <div class="pr-lg-5"><img src="{{asset('assets/customlogin/img/illustration.svg')}}" alt="" class="img-fluid"></div>
          </div>
    ...
    <script src="{{asset('homepage/vendors/popper.js/umd/popper.min.js')}}"> </script>
    <script src="{{asset('homepage/vendors/jquery.cookie/jquery.cookie.js')}}"> </script>
    <script src="{{asset('homepage/vendors/chart.js/Chart.min.js')}}"></script>
